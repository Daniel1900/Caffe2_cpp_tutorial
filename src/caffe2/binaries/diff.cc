...
C10_DEFINE_string(model, "googlenet", "Name of model.");
C10_DEFINE_bool(short, false, "use short format.");

C10_DEFINE_bool(code, false, "use in-code model.");
C10_DEFINE_bool(file, false, "use in-file model.");
