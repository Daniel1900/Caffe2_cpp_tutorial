...
#ifdef WITH_CUDA
  if (!force_cpu) {
    fc->mutable_device_option()->set_device_type(PROTO_CUDA);
    sum->mutable_device_option()->set_device_type(PROTO_CUDA);
    lstm->mutable_device_option()->set_device_type(PROTO_CUDA);
